...
exports.GAME_MODE_ROLE_NAMES = exports.UTILITY_ROLE_NAMES = exports.STAFF_ROLE_NAMES = exports.ROLE_NAMES = exports.ALL_ROLES = void 0;
const GAME_MODES = [
...
for (const staff of STAFF_ROLES) {
    exports.ALL_ROLES.push(staff);
}
exports.ROLE_NAMES = exports.ALL_ROLES.map(r => r.name);
exports.STAFF_ROLE_NAMES = STAFF_ROLES.filter(r => r.isStaff).map(r => r.name);
exports.UTILITY_ROLE_NAMES = STAFF_ROLES.filter(r => r.isUtility).map(r => r.name);
exports.GAME_MODE_ROLE_NAMES = exports.ALL_ROLES.filter(r => r.mode && r.tier).map(r => r.name);
